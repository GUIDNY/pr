 ...
 *
 * It is a component and not the route so that the route can be two routes: a
 * public one the CDN caches, and an admin one that reads the session. See
 * product/[slug]/page.tsx and product-admin/[slug]/page.tsx — the whole point
 * is that this file cannot tell who is asking, and so cannot make the page
 * uncacheable by accident.
 */
