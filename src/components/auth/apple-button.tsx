...
export function AppleButton() {
  ...
  return (
    <a
      href={href}
      className="flex h-12 w-full items-center justify-center gap-3 rounded-xl bg-black text-base font-semibold text-white shadow-sm transition-all hover:shadow-md hover:opacity-90"
    >
