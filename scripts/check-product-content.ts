...
console.log(`  no summary                ${noSummary}   <- no opening paragraph to take one from,`);
console.log(`                                    or its first sentence is longer than the whole`);
console.log(`                                    budget. Never borrowed from further down: that`);
console.log(`                                    printed the same paragraph twice.`);
